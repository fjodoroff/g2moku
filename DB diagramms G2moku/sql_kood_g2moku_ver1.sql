...
ALTER TABLE Game_World_Tiles DROP CONSTRAINT FK_Game_World_Tile_ID;
ALTER TABLE Game_World_Tiles DROP CONSTRAINT FK_Game_World_Tiles37;
...
CREATE INDEX idx_Game_World_Tile_ID ON Game_World_Tiles (Game_Tile_Game_Tile_ID );
CREATE TABLE Game (
...
ALTER TABLE Game_World ADD CONSTRAINT FK_Game_World_pk_Game_ID FOREIGN KEY (PK_Game_ID) REFERENCES Game (PK_Game_ID)  ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE Game_World_Tiles ADD CONSTRAINT FK_Game_World_Tile_ID FOREIGN KEY (Game_Tile_Game_Tile_ID) REFERENCES Game_Tile (Game_Tile_ID)  ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE Game_World_Tiles ADD CONSTRAINT FK_Game_World_Tiles37 FOREIGN KEY (Game_World_Game_World_ID) REFERENCES Game_World (Game_World_ID)  ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE Player_Move ADD CONSTRAINT FK_Player_Move_pk_Player_ID FOREIGN KEY (PK_Player_ID) REFERENCES Player (PK_Player_ID)  ON DELETE NO ACTION ON UPDATE NO ACTION;
