...
ALTER TABLE 2 DROP CONSTRAINT FK_28;
ALTER TABLE 2 DROP CONSTRAINT FK_29;
ALTER TABLE 3 DROP CONSTRAINT FK_312;
ALTER TABLE 3 DROP CONSTRAINT FK_313;
...
CREATE TABLE 3 (
	...
	CONSTRAINT PK_317 PRIMARY KEY (Game_World_Tile_ID, Game_World_ID)
	);
CREATE INDEX TC_316 ON 3 (Game_World_Tile_ID );
CREATE INDEX TC_317 ON 3 (Game_World_ID );
...
CREATE TABLE 2 (
	Game_ID INTEGER NOT NULL,
	Player_ID INTEGER NOT NULL,
	CONSTRAINT PK_212 PRIMARY KEY (Game_ID, Player_ID)
	);
CREATE INDEX TC_212 ON 2 (Game_ID );
CREATE INDEX TC_213 ON 2 (Player_ID );
CREATE TABLE Player (
	Player_ID INTEGER NOT NULL,
...
ALTER TABLE 2 ADD CONSTRAINT FK_28 FOREIGN KEY (Game_ID) REFERENCES Game (Game_ID)  ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE 2 ADD CONSTRAINT FK_29 FOREIGN KEY (Player_ID) REFERENCES Player (Player_ID)  ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE 3 ADD CONSTRAINT FK_312 FOREIGN KEY (Game_World_Tile_ID) REFERENCES Game_World_Tile (Game_World_Tile_ID)  ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE 3 ADD CONSTRAINT FK_313 FOREIGN KEY (Game_World_ID) REFERENCES Game_World (Game_World_ID)  ON DELETE NO ACTION ON UPDATE NO ACTION;
